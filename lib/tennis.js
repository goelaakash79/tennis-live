...
async function fetchTennisFromApiTennisOnly() {
  ...
  // event_key → player keys (only rows we need for flag lookup)
  ...
  // Only resolve flags for players in matches we actually show — not every singles
  // row in the fixtures feed (that can trigger hundreds of get_players calls).
